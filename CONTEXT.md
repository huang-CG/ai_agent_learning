...
### 复盘日程（Agent 维护 · 2026-08-18）

| 类型 | 周期 | 时长 | 期间 | 封顶 | 下次触发 | 状态 |
|------|------|------|------|------|----------|------|
| **周复盘** | 每 **7 个学习日** | 固定 2 天 | 暂停每日新课 | 最多 2 天 | D35 起计 **5/7**（满 7 后触发） | ✅ 第 1 次完成（D28–D34） |
...
| 3 | D28–47 | 🔄 12/20 | RAG Agent + Web UI |
